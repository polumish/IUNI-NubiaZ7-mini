...
//    PackageParser.Package mPkgInfo;//huangbin hide
    ...
    private void startInstallConfirm() {
        ...
        if(mPkgInfo != null) {
            //Gionee qiuxd 20121015 modify for CR00711865 start 
            /*AppSecurityPermissions asp = new AppSecurityPermissions(this, mPkgInfo);
            if(asp.getPermissionCount() > 0) {
                permVisible = true;
                securityList.addView(mAsp.getPermissionsView());
            }*/
        	
        	//huangbin hide begin
//            if(mGnAppPermCtrl){
//                mGnAsp = new GNAppSecurityPermissions(this, mPkgInfo);
//                if(mGnAsp.getPermissionCount() > 0) {
//                    permVisible = true;
//                    securityList.addView(mGnAsp.getPermissionsView());
//                }
//            }else{
//                /*AppSecurityPermissions asp = new AppSecurityPermissions(this, mPkgInfo);
//                if(asp.getPermissionCount() > 0) {
...
//            }
            //huangbin hide end
            //Gionee qiuxd 20121015 modfiy for CR00711865 end 
            
            //huangbin add begin
            asp = new AppSecurityPermissions(this, mPkgInfo);
            if(asp.getPermissionCount() > 0) {
                permVisible = true;
                securityList.addView(asp.getPermissionsView());
            }
...
//        mPkgInfo = PackageUtil.getPackageInfo(sourceFile);//huangbin hide 
