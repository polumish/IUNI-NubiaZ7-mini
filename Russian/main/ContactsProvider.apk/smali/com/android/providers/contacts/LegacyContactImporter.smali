...
.method public constructor <init>(Landroid/content/Context;Lcom/android/providers/contacts/ContactsProvider2;)V
    ...
    .param p2, "contactsProvider"    # Lcom/android/providers/contacts/ContactsProvider2;
...
.method private insertCall(Landroid/database/Cursor;)V
    ...
    sget-object v1, Lgionee/provider/GnCallLog$Calls;->CONTENT_URI:Landroid/net/Uri;
...
.method private insertPhone(Landroid/database/Cursor;Landroid/database/sqlite/SQLiteStatement;Landroid/database/sqlite/SQLiteStatement;Landroid/database/sqlite/SQLiteStatement;)V
    .locals 11
    .param p1, "c"    # Landroid/database/Cursor;
    .param p2, "phoneInsert"    # Landroid/database/sqlite/SQLiteStatement;
    .param p3, "phoneLookupInsert"    # Landroid/database/sqlite/SQLiteStatement;
    .param p4, "hasPhoneUpdate"    # Landroid/database/sqlite/SQLiteStatement;
    ...
    .line 983
    invoke-static {v7}, Lcom/android/providers/contacts/util/PhoneNumberUtils;->getStrippedReversed(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7}, Lcom/android/providers/contacts/util/PhoneNumberUtils;->toCallerIDMinMatch(Ljava/lang/String;)Ljava/lang/String;
...
.method private insertPhoto(Landroid/database/Cursor;Landroid/database/sqlite/SQLiteStatement;Landroid/database/sqlite/SQLiteStatement;)V
    ...
    .param p1, "c"    # Landroid/database/Cursor;
    .param p2, "insert"    # Landroid/database/sqlite/SQLiteStatement;
    .param p3, "photoIdUpdate"    # Landroid/database/sqlite/SQLiteStatement;
...
.method private updateDisplayNamesAndLookupKeys()V
    ...
    sget-object v1, Lgionee/provider/GnContactsContract$RawContacts;->CONTENT_URI:Landroid/net/Uri;
    ...
    invoke-virtual {v0, v1, v7, v8, v2}, Lcom/android/providers/contacts/ContactsDatabaseHelper;->updateRawContactDisplayName(Landroid/database/sqlite/SQLiteDatabase;JZ)V
